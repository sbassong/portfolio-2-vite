		...
		<div className="top-nav">
			<div className="top-nav-wrap">
				...
				<nav className='top-right-nav'>
					...
					<a className='resume-link' href="https://drive.google.com/file/d/1nbQ_AZRQ_H4zSoY5rS8ZEr4BYIClraxv/view?usp=drive_link" target="_blank" rel="noopener noreferrer">Resume</a>
				</nav>
			</div>
		</div>
	)
